...
impl Message for Request {
    fn into_raw(self, sender: ObjectId) -> RawMessage {
        match self {
            Request::GetShellSurface { id, surface } => RawMessage {
                sender,
                opcode: Opcode(1),
    ...
    fn from_raw(
        ...
        match m.opcode {
            Opcode(1) => Ok(Request::GetShellSurface {
...
impl Message for Event {
    ...
    fn into_received_event(self, con: Rc<RefCell<dyn Connection>>, id: ObjectId) -> EventSet {
        EventSet::WlShell(WlShell::new(con, id), self)
    }
...
impl core::fmt::Debug for WlShell {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "WlShell@{}", self.object_id.0)
    }
}

impl Into<Payload> for WlShell {
    fn into(self) -> Payload {
...
impl Interface for WlShell {
    ...
    fn new(con: Rc<RefCell<dyn Connection>>, object_id: ObjectId) -> WlShell {
        WlShell { con, object_id }
    }
