#!/usr/bin/env python3
#
#  QEMU denies a x86_64 multiboot elf file (GRUB2 accept it, btw) so replace em_machine
#  in the ELF header to pretend to be an x86 elf image in order to make it bootable in QEMU.
#
