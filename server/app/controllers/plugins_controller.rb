class PluginsController < ApplicationController
  ...
  def download
    ...
    if Rails.env.production?
      ...
      if name == 'nodejs-runtime'
        # Build nodejs-runtime in the local repository.
  ...
  unless Rails.env.production?
    def build_local_app_runtime
      plugin_zip_path = File.join(Dir.home, '.makestack', 'server', 'nodejs-runtime.plugin.zip')
      ...
      app_runtime_dir = File.join(File.dirname(__FILE__), '../../../libs/nodejs-runtime')
